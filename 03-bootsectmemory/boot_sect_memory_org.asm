...
;still fails regardless of the org, still not point to the data
mov al, "1"
int 0x10
mov al, the_secret
int 0x10

;UPDATE: Having solved the correct problem with org, this now works
...
;UPDATE: As expected we are adding 0x7c00 twice so it will not work
;ATTEMPT 3 DEAR GOD
